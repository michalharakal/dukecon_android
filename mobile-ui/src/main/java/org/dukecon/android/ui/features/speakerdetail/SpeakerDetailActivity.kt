...
//            }
        ...
        private fun buildTransitionPairs(view: View): Array<Pair<View, String>> {
            ...
            view.getActivity()?.let {
                ...
                val statusBarBackground = decor.findViewById(android.R.id.statusBarBackground) as View
                if (statusBarBackground != null) {
                    pairs.add(Pair.create(statusBarBackground, statusBarBackground.transitionName))
                }

                val navBar = decor.findViewById(android.R.id.navigationBarBackground) as View
                if (navBar != null) {
